...
const Menubar = ({isAuthenticated, onLogout}) => {
  return (
    <nav className="relative container mx-auto p-6">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden space-x-6 md:flex">
          ...
          <NavLink to={"/employees"} className="hover:text-yellow-500">
            Employees
          </NavLink>
          <NavLink to={"/events"} className="hover:text-yellow-500">
            Events
          </NavLink>
          <NavLink to={"/events/new"} className="hover:text-yellow-500">
            Register Event
          </NavLink>
          {isAuthenticated ? (
            <NavLink
        ...
        <a
          href="#"
          className="hidden p-3 px-6 pt-2 text-black bg-yellow-300 rounded-full baseline hover:bg-yellow-200 md:block"
        >
          Contact Us
        </a>
